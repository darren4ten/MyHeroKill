...
namespace MyHeroKill.Service
{
    public class CardService
    {
        ...
        public List<Card> GetAllCard()
        {
            ...
            list.Add(new Card() { IndexInCards = 1, CardGloabalType = Enums.ECardGloabalType.Juedou, AttackDistance = 999, IsJuedou = true, Name = "红桃A", Number = 1, Type = Enums.ECardColorAndSignType.HongTao });
            ...
            list.Add(new Card() { IndexInCards = 5, CardGloabalType = Enums.ECardGloabalType.Tanlangquwu, AttackDistance = 1, IsTanlangquwu = true, Name = "红桃2", Number = 2, Type = Enums.ECardColorAndSignType.HongTao });
            list.Add(new Card() { IndexInCards = 6, CardGloabalType = Enums.ECardGloabalType.Sha, AttackDistance = 1, IsSha = true, Name = "黑桃2", Number = 2, Type = Enums.ECardColorAndSignType.HeiTao });
            ...
            list.Add(new Card() { IndexInCards = 10, CardGloabalType = Enums.ECardGloabalType.Fudichouxin, AttackDistance = 999, IsFudichouxin = true, Name = "黑桃3", Number = 3, Type = Enums.ECardColorAndSignType.HeiTao });
            ...
            list.Add(new Card() { IndexInCards = 12, CardGloabalType = Enums.ECardGloabalType.Fudichouxin, AttackDistance = 999, IsFudichouxin = true, Name = "梅花3", Number = 3, Type = Enums.ECardColorAndSignType.MeiHua });

            list.Add(new Card() { IndexInCards = 13, CardGloabalType = Enums.ECardGloabalType.Tanlangquwu, AttackDistance = 1, IsTanlangquwu = true, Name = "红桃4", Number = 4, Type = Enums.ECardColorAndSignType.HongTao });
            list.Add(new Card() { IndexInCards = 14, CardGloabalType = Enums.ECardGloabalType.Sha, AttackDistance = 1, IsSha = true, Name = "黑桃4", Number = 4, Type = Enums.ECardColorAndSignType.HeiTao });
            ...
            list.Add(new Card() { IndexInCards = 16, CardGloabalType = Enums.ECardGloabalType.Tanlangquwu, AttackDistance = 1, IsTanlangquwu = true, Name = "梅花4", Number = 4, Type = Enums.ECardColorAndSignType.MeiHua });
            ...
            list.Add(new Card() { IndexInCards = 18, CardGloabalType = Enums.ECardGloabalType.Sha, AttackDistance = 1, IsSha = true, Name = "黑桃5", Number = 5, Type = Enums.ECardColorAndSignType.HeiTao });
            ...
            list.Add(new Card() { IndexInCards = 21, CardGloabalType = Enums.ECardGloabalType.Sha, AttackDistance = 1, IsSha = true, Name = "红桃6", Number = 6, Type = Enums.ECardColorAndSignType.HongTao });
            list.Add(new Card() { IndexInCards = 22, CardGloabalType = Enums.ECardGloabalType.Sha, AttackDistance = 1, IsSha = true, Name = "黑桃6", Number = 6, Type = Enums.ECardColorAndSignType.HeiTao });
            list.Add(new Card() { IndexInCards = 23, CardGloabalType = Enums.ECardGloabalType.Huadiweilao, AttackDistance = 999, IsHuadiweilao = true, Name = "方块6", Number = 6, Type = Enums.ECardColorAndSignType.FangPian });
            ...
            list.Add(new Card() { IndexInCards = 27, CardGloabalType = Enums.ECardGloabalType.Sha, AttackDistance = 1, IsSha = true, Name = "方块7", Number = 7, Type = Enums.ECardColorAndSignType.FangPian });
            list.Add(new Card() { IndexInCards = 28, CardGloabalType = Enums.ECardGloabalType.Sha, AttackDistance = 1, IsSha = true, Name = "梅花7", Number = 7, Type = Enums.ECardColorAndSignType.MeiHua });
            ...
            list.Add(new Card() { IndexInCards = 30, CardGloabalType = Enums.ECardGloabalType.Sha, AttackDistance = 1, IsSha = true, Name = "黑桃8", Number = 8, Type = Enums.ECardColorAndSignType.HeiTao });
            list.Add(new Card() { IndexInCards = 31, CardGloabalType = Enums.ECardGloabalType.Sha, AttackDistance = 1, IsSha = true, Name = "方块8", Number = 8, Type = Enums.ECardColorAndSignType.FangPian });
            list.Add(new Card() { IndexInCards = 32, CardGloabalType = Enums.ECardGloabalType.Sha, AttackDistance = 1, IsSha = true, Name = "梅花8", Number = 8, Type = Enums.ECardColorAndSignType.MeiHua });
            ...
            list.Add(new Card() { IndexInCards = 34, CardGloabalType = Enums.ECardGloabalType.Sha, AttackDistance = 1, IsSha = true, Name = "黑桃9", Number = 9, Type = Enums.ECardColorAndSignType.HeiTao });
            list.Add(new Card() { IndexInCards = 35, CardGloabalType = Enums.ECardGloabalType.Sha, AttackDistance = 1, IsSha = true, Name = "方块9", Number = 9, Type = Enums.ECardColorAndSignType.FangPian });
            list.Add(new Card() { IndexInCards = 36, CardGloabalType = Enums.ECardGloabalType.Sha, AttackDistance = 1, IsSha = true, Name = "梅花9", Number = 9, Type = Enums.ECardColorAndSignType.MeiHua });

            list.Add(new Card() { IndexInCards = 37, CardGloabalType = Enums.ECardGloabalType.Sha, AttackDistance = 1, IsSha = true, Name = "红桃10", Number = 10, Type = Enums.ECardColorAndSignType.HongTao });
            list.Add(new Card() { IndexInCards = 38, CardGloabalType = Enums.ECardGloabalType.Sha, AttackDistance = 1, IsSha = true, Name = "黑桃10", Number = 10, Type = Enums.ECardColorAndSignType.HeiTao });
            list.Add(new Card() { IndexInCards = 39, CardGloabalType = Enums.ECardGloabalType.Sha, AttackDistance = 1, IsSha = true, Name = "方块10", Number = 10, Type = Enums.ECardColorAndSignType.FangPian });
            list.Add(new Card() { IndexInCards = 40, CardGloabalType = Enums.ECardGloabalType.Sha, AttackDistance = 1, IsSha = true, Name = "梅花10", Number = 10, Type = Enums.ECardColorAndSignType.MeiHua });
            ...
            list.Add(new Card() { IndexInCards = 42, CardGloabalType = Enums.ECardGloabalType.Sha, AttackDistance = 1, IsSha = true, Name = "黑桃J", Number = 11, Type = Enums.ECardColorAndSignType.HeiTao });
            ...
            list.Add(new Card() { IndexInCards = 44, CardGloabalType = Enums.ECardGloabalType.Tanlangquwu, AttackDistance = 1, IsTanlangquwu = true, Name = "梅花J", Number = 11, Type = Enums.ECardColorAndSignType.MeiHua });
            ...
            list.Add(new Card() { IndexInCards = 51, CardGloabalType = Enums.ECardGloabalType.Sha, AttackDistance = 1, IsSha = true, Name = "方块K", Number = 13, Type = Enums.ECardColorAndSignType.FangPian });
            ...
            list.Add(new Card() { IndexInCards = 54, CardGloabalType = Enums.ECardGloabalType.Juedou, AttackDistance = 999, IsJuedou = true, Name = "黑桃A", Number = 1, Type = Enums.ECardColorAndSignType.HeiTao });
            ...
            list.Add(new Card() { IndexInCards = 61, CardGloabalType = Enums.ECardGloabalType.Tanlangquwu, AttackDistance = 1, IsTanlangquwu = true, Name = "红桃3", Number = 3, Type = Enums.ECardColorAndSignType.HongTao });
            list.Add(new Card() { IndexInCards = 62, CardGloabalType = Enums.ECardGloabalType.Fudichouxin, AttackDistance = 999, IsFudichouxin = true, Name = "黑桃3", Number = 3, Type = Enums.ECardColorAndSignType.HeiTao });
            ...
            list.Add(new Card() { IndexInCards = 64, CardGloabalType = Enums.ECardGloabalType.Fudichouxin, AttackDistance = 999, IsFudichouxin = true, Name = "梅花3", Number = 3, Type = Enums.ECardColorAndSignType.MeiHua });
            ...
            list.Add(new Card() { IndexInCards = 66, CardGloabalType = Enums.ECardGloabalType.Fudichouxin, AttackDistance = 999, IsFudichouxin = true, Name = "黑桃4", Number = 4, Type = Enums.ECardColorAndSignType.HeiTao });
            ...
            list.Add(new Card() { IndexInCards = 68, CardGloabalType = Enums.ECardGloabalType.Fudichouxin, AttackDistance = 999, IsFudichouxin = true, Name = "梅花4", Number = 4, Type = Enums.ECardColorAndSignType.MeiHua });
            ...
            list.Add(new Card() { IndexInCards = 74, CardGloabalType = Enums.ECardGloabalType.Huadiweilao, AttackDistance = 999, IsHuadiweilao = true, Name = "黑桃6", Number = 6, Type = Enums.ECardColorAndSignType.HeiTao });
            ...
            list.Add(new Card() { IndexInCards = 76, CardGloabalType = Enums.ECardGloabalType.Huadiweilao, AttackDistance = 999, IsHuadiweilao = true, Name = "梅花6", Number = 6, Type = Enums.ECardColorAndSignType.MeiHua });
            ...
            list.Add(new Card() { IndexInCards = 82, CardGloabalType = Enums.ECardGloabalType.Sha, AttackDistance = 1, IsSha = true, Name = "黑桃8", Number = 8, Type = Enums.ECardColorAndSignType.HeiTao });
            ...
            list.Add(new Card() { IndexInCards = 84, CardGloabalType = Enums.ECardGloabalType.Sha, AttackDistance = 1, IsSha = true, Name = "梅花8", Number = 8, Type = Enums.ECardColorAndSignType.MeiHua });
            ...
            list.Add(new Card() { IndexInCards = 86, CardGloabalType = Enums.ECardGloabalType.Sha, AttackDistance = 1, IsSha = true, Name = "黑桃9", Number = 9, Type = Enums.ECardColorAndSignType.HeiTao });
            ...
            list.Add(new Card() { IndexInCards = 88, CardGloabalType = Enums.ECardGloabalType.Sha, AttackDistance = 1, IsSha = true, Name = "梅花9", Number = 9, Type = Enums.ECardColorAndSignType.MeiHua });

            list.Add(new Card() { IndexInCards = 89, CardGloabalType = Enums.ECardGloabalType.Sha, AttackDistance = 1, IsSha = true, Name = "红桃10", Number = 10, Type = Enums.ECardColorAndSignType.HongTao });
            list.Add(new Card() { IndexInCards = 90, CardGloabalType = Enums.ECardGloabalType.Sha, AttackDistance = 1, IsSha = true, Name = "黑桃10", Number = 10, Type = Enums.ECardColorAndSignType.HeiTao });
            ...
            list.Add(new Card() { IndexInCards = 92, CardGloabalType = Enums.ECardGloabalType.Sha, AttackDistance = 1, IsSha = true, Name = "梅花10", Number = 10, Type = Enums.ECardColorAndSignType.MeiHua });

            list.Add(new Card() { IndexInCards = 93, CardGloabalType = Enums.ECardGloabalType.Sha, AttackDistance = 1, IsSha = true, Name = "红桃J", Number = 11, Type = Enums.ECardColorAndSignType.HongTao });
            list.Add(new Card() { IndexInCards = 94, CardGloabalType = Enums.ECardGloabalType.Sha, AttackDistance = 1, IsSha = true, Name = "黑桃J", Number = 11, Type = Enums.ECardColorAndSignType.HeiTao });
            ...
            list.Add(new Card() { IndexInCards = 99, CardGloabalType = Enums.ECardGloabalType.Fudichouxin, AttackDistance = 999, IsFudichouxin = true, Name = "方块Q", Number = 12, Type = Enums.ECardColorAndSignType.FangPian });
            list.Add(new Card() { IndexInCards = 100, CardGloabalType = Enums.ECardGloabalType.Fudichouxin, AttackDistance = 999, IsFudichouxin = true, Name = "梅花Q", Number = 12, Type = Enums.ECardColorAndSignType.MeiHua });
